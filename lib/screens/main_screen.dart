  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
          ...
          height: 70,
          items: <Widget>[
            // Icon(Icons.explore_outlined, size: 30, color: _page==0? myGrey: Colors.black,),
            // Icon(Icons.keyboard, size: 30, color: _page==1? myGrey: Colors.black),
            // Icon(Icons.dashboard_outlined, size: 30, color: _page==2? myGrey: Colors.black),
            // Icon(Icons.timelapse, size: 30, color: _page==3? myGrey: Colors.black,),
            Icon(Icons.account_circle_outlined, size: 30, color: _page==0? myGrey: Colors.black,),
          ],
          onTap: (index) {
            setState(() {
              _page = index;
